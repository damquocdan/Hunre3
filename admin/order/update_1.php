...
<div class="content">
  <div class="container">
    ...
    <div class="box box-primary">
      <div class="box-body">
        <form action="index.php?act=update_order_processing_total" method="post" class="table-responsive">
          ...
          <table width="100%" class="table table-hover table-bordered text-center">
            ...
            <tbody>
              ...
              foreach ($order_total as $ot) {
                ...
                // $delete_order_total = "index.php?act=delete_order_processing_total&id_order_total=" . $id_order_total . "&id_order=" . $id_order;
              ?>
                <tr>
                  <td>
                    <?= $name ?>
          ...
          <a href="index.php?act=list_order_processing" class="btn btn-dark">Quay lại</a>
        </form>
      </div>
    </div>
  </div>
