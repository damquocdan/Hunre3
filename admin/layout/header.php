  ...
  <div class="wrapper">
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components text-secondary">
        ...
        <!-- Sản phẩm -->
        <li>
          <a href="#products" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle no-caret-down"><i class="fas fa-table"></i>Phòng
            <i class="fas fa-angle-right float-xl-right"></i>
          </a>
        ...
        <li>
          <a href="#order" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle no-caret-down"><i class="fas fa-list-alt"></i>Đơn đặt thuê
            <i class="fas fa-angle-right float-xl-right"></i>
          </a>
          <ul class="collapse list-unstyled" id="order">
            ...
            <li>
              <a href="index.php?act=list_order_processing"><i class="fas fa-shipping-fast"></i></i>Danh sách đơn thuê đang xử lý (<?= $order_processing ?>)</a>
            </li>
            <li>
              <a href="index.php?act=list_order_delivering"><i class="fas fa-shipping-fast"></i></i>Danh sách đơn thuê đang bàn giao (<?= $order_delivering ?>)</a>
            </li>
            <li>
              <a href="index.php?act=list_order_delivered"><i class="fas fa-shipping-fast"></i></i>Danh sách đơn thuê đã đặt thành công (<?= $order_delivered ?>)</a>
            </li>
          </ul>
        </li>
